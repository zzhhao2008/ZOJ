        ...
        if ($txt[0] === '^') {
            ...
            switch ($cfg_line[0]) {
                case '^problem':
                    ...
                    $cmplog .= "在行$line 以" . $cfg_line[2] . "方式引入题目" . $cfg_line[1] . $pcfg['title'] . "并编号：" . ($cfg_line[3] ?? $pcnt) .
                    "<a href='problem_edit?pid=$cfg_line[1]' target='_blank'>编辑</a>" .
                    "<br>";
                    break;
                default:
...
<form method="post" class="row" id="tableA">
    ...
    <div class="col-sm-4  problemsubbox">
        ...
        <div>
            ...
            <a class="btn btn-info" href='practiceshow?id=<?= $tid ?>'>预览</a>
        </div>
    </div>
</form>
